...
class BoardEvaluation:
    ...
    def material_score(pieces_lists):
        ...
        for piece_type in chessboard.PieceType.piece_type_list():
            if piece_type == chessboard.PieceType.KING:
                continue
            value = None
            if piece_type == chessboard.PieceType.QUEEN:
                value = 900
            elif piece_type == chessboard.PieceType.ROOK:
                value = 500
            elif piece_type == chessboard.PieceType.BISHOP:
                value = 330
            elif piece_type == chessboard.PieceType.KNIGHT:
                value = 320
            elif piece_type == chessboard.PieceType.PAWN:
                value = 100
            material_score += value * (len(pieces_lists[piece_type][chessboard.Color.WHITE]) - len(pieces_lists[piece_type][chessboard.Color.BLACK]))
